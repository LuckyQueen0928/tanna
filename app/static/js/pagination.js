        ...
        if (showPrevious || showPageNumbers || showNext) {
          ...
          if (showPrevious) {
            if (currentPage-10 < 1) {
              ...
              html += '<li class="' + classPrefix + '-prev J-paginationjs-previous" data-num="' + (currentPage - 10) + '" title="Previous page"><a href="' + pageLink + '">' + prevText + '<\/a><\/li>';
            }
          }
          ...
          if (showNext) {
            if (currentPage+10 > totalPage) {
              ...
              html += '<li class="' + classPrefix + '-next J-paginationjs-next" data-num="' + (currentPage + 10) + '" title="Next page"><a href="' + pageLink + '">' + nextText + '<\/a><\/li>';
            }
          }
          html += '<\/ul><\/div>';
        }
